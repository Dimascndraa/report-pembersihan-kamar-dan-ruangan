...
use App\Http\Controllers\DefaultController\DatatablesController;
use App\Http\Controllers\DefaultController\FormController;
use App\Http\Controllers\DefaultController\FormpluginsController;
use App\Http\Controllers\DefaultController\IconsController;
use App\Http\Controllers\DefaultController\InfoappController;
use App\Http\Controllers\DefaultController\IntelController;
use App\Http\Controllers\DefaultController\MiscellaneousController;
use App\Http\Controllers\DefaultController\NotificationsController;
use App\Http\Controllers\DefaultController\PageController;
use App\Http\Controllers\DefaultController\PluginController;
use App\Http\Controllers\DefaultController\SettingController;
use App\Http\Controllers\DefaultController\StatisticsController;
use App\Http\Controllers\DefaultController\TablesController;
use App\Http\Controllers\DefaultController\UiController;
use App\Http\Controllers\DefaultController\UtilitiesController;
use Illuminate\Support\Facades\Route;

// INTEL
Route::get('/home', [IntelController::class, 'index'])->name('beranda');
