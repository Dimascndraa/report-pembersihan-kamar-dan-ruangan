...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        ...
        @slot('sh_titile_main') Tempat Tidur: <span class='fw-300'>{{ $ruangan->name }}</span> <sup
    ...
    <div class="row">
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        Tempat Tidur di Kelas Rawat <span class="fw-300"><i>{{ $ruangan->name }}</i></span>
                    </h2>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="white-space: normal">{{
                                        $bed->name }}</td>
                                    <td style="white-space: normal">{{ $bed->bed_number }}</td>
                                    <td style="white-space: normal">
                                        <a href="/bed/{{ $bed->id }}" style="transform: scale(1.1)"
                                        ...
                                        <button type="button" class="badge mx-1 badge-primary p-2 border-0 text-white"
                                            data-toggle="modal" data-target="#ubah-ruang{{ $bed->id }}" title="Ubah">
                                            <span class="fal fa-pencil mr-1"></span>
                                        </button>
                                        <form action="/ruanganbed $bed->id }}" method="POST" class="d-inline">
                                            @method('delete')
                                            @csrf
                                ...
                                <div class="modal fade" id="ubah-ruang{{ $bed->id }}" tabindex="-1" role="dialog"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <form autocomplete="off" novalidate action="/ruanganbed $bed->id }}"
                                                method="post">
                                                @method('put')
                                                @csrf
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ old('name', $bed->name) }}"
...
<div class="modal fade" id="default-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form autocomplete="off" novalidate action="/bed" method="post">
                @csrf
                <input type="hidden" name="room_id" value="{{ $ruangan->id }}">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Tempat Tidur</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="name">Tempat Tidur</label>
                    ...
                    <div class="form-group">
                        <label for="bed_number">Nomor Tempat Tidur</label>
                        <input type="text" value="{{ old('bed_number') }}"
                            class="form-control @error('bed_number') is-invalid @enderror" id="bed_number"
                            name="bed_number" placeholder="Nomor Tempat Tidur"
                            onkeyup="this.value = this.value.toUpperCase()">
                        @error('bed_number')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
